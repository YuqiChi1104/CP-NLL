...
n_classes=100
checkpoint_path = "./model/SED/model/cifar100/cifar10050_0.9_55.pth"
noise_file = "./SED/noise/cifar100/cifar100_symmetric_0.9.json"
...
with open(train_file, 'rb') as f:
    ...
    train_images = dict_data['data'].reshape(-1, 3, 32, 32)
    train_labels = np.array(dict_data['fine_labels'])
