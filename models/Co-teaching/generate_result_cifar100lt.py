...
input_channel=3
gpuid = 1
checkpoint_path = "./coteaching/model/cifar100lt50/cifar100lt_r0.9_50_epoch200.pth"
data_dir = "./data/cifar-100-lt-50/cifar100-train.arrow"
save_dir = "./lt"
noise_file = "./coteaching/noise/cifar100lt50/cifar-100_lt_r50_noise0.9.json"
